...
<div class="container">
    <div class="logo-container">
        <a class="navbar-brand" href="#">
            <img src="{{ asset('ATU.jpeg') }}" alt="School Logo" class="logo">
        </a>
    </div>
    <h4 class="text-center mb-4 font-weight-bold" style="font-family: sans-serif">WELCOME TO THE SECURITY PERSONNEL DUTY ALLOCATION AND RECORD SYSTEM</h4>
